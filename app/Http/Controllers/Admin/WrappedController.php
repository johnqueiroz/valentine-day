...
class WrappedController extends Controller
{
    ...
    protected function validateData(Request $request): array
    {
        return $request->validate([
            ...
            'gifter_name' => ['required', 'string', 'max:100'],
            'love_letter' => ['required', 'string', 'max:2000'],
            'relationship_started_on' => ['required', 'date'],
            ...
            'tracks.*.artist' => ['required', 'string', 'max:150'],
            'tracks.*.youtube_url' => ['required', 'url', 'max:255'],
        ], [
            'couple_name_1.required' => 'O nome da primeira pessoa é obrigatório.',
            'couple_name_2.required' => 'O nome da segunda pessoa é obrigatório.',
            'gifter_name.required' => 'Informe quem está presenteando.',
            'love_letter.required' => 'A cartinha do casal é obrigatória.',
            'relationship_started_on.required' => 'A data de início do relacionamento é obrigatória.',
            'tracks.required' => 'Adicione pelo menos uma faixa.',
            'tracks.min' => 'Adicione pelo menos uma faixa.',
            'tracks.*.title.required' => 'O nome da música é obrigatório.',
            'tracks.*.artist.required' => 'O artista é obrigatório.',
            'tracks.*.youtube_url.required' => 'O link do YouTube é obrigatório.',
            'tracks.*.youtube_url.url' => 'Informe um link do YouTube válido.',
        ]);
    }
